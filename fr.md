...
- Tout au long de ce document, j'utiliserai
  ...
  - lettres majuscules simples (par exemple `X`) pour représenter tout [*content word*](https://github.com/kilipan/nasin-toki#content-words) ou [*phrase*](https://github.com/kilipan/nasin-toki#phrases) de toki pona valide
